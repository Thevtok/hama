...
class DateMonitoringPemakaian extends StatefulWidget {
  final String item;
  const DateMonitoringPemakaian({super.key, required this.item});

  @override
  State<DateMonitoringPemakaian> createState() => _DateMonitoringPemakaianState();
}

class _DateMonitoringPemakaianState extends State<DateMonitoringPemakaian> {
            ...
            children: [
              ...
              Column(
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => FromDataMonitoringPemakaian(
